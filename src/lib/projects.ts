      ...
      },
      {
        ...
        blocks: [
          { type: 'p', content: 'The redesigned platform is live. Decisions were validated by a measurable reduction in merchant support requests following launch.' },
          {
            type: 'insight',
            title: 'What I\'d do differently',
            content: '*We underinvested in the analytics dashboard. Merchants wanted deeper insights — conversion rates by crypto type and peak \nsale periods.*'
          },
          {
            type: 'metrics',
            items: [
