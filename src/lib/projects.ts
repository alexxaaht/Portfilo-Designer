  ...
  // ── UkrSibBank ───────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', content: 'Looking back, the most valuable part of this project wasn\'t the interface – it was the research. **We found a problem that looked like a tooling problem but was actually a systemic problem.** Managers weren\'t struggling because they lacked a chat tool, but because of a lack \nof designed internal experience.' },
          {
            type: 'card',
            title: 'What I\'d do differently',
            content: 'We spent more time on the manager experience. The client\'s perspective – receiving a message through the new system – deserves \nits own research thread.'
          },
          {
            type: 'metrics',
            items: [
    ...
    sections: [
      {
        num: '01',
        title: 'Overview',
        heading: 'Premium experience for **professional investors**',
        blocks: [
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            content: "The three-tier package structure wasn't just a business decision – it was a design decision. \n**We needed to make IFREQ accessible at different stages.**"
          },
          {
            type: 'card',
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', content: 'Findings showed: **merchants didn\'t care about blockchain. They cared about getting paid and having a paper trail.**' },
          {
            ...
            content: '*"I had no idea if it worked. The screen said something... I had to pretend I knew what was happening." \nThat story became our design north star.*'
          },
      ...
      },
      {
        ...
        blocks: [
          { type: 'p', content: 'The redesigned platform is live. Decisions were validated by a measurable reduction in merchant support requests following launch.' },
          {
            type: 'insight',
            title: 'What I\'d do differently',
            content: 'We underinvested in the analytics dashboard. Merchants wanted deeper insights – conversion rates by crypto \ntype and peak sale periods.'
          },
          {
            type: 'metrics',
            items: [
              { n: '−40', su: '%', d: 'Reduction in merchant support requests related to currency conversions' },
              { n: '5', d: 'Device breakpoints – each with a custom responsive layout' },
        ...
        blocks: [
          {
            ...
            items: [
              ...
              { n: '03', t: 'Information Architecture & Wallet ID Concept', d: 'Defined the core IA. Developed the Wallet ID concept – replacing 0x-style addresses with readable Wallet IDs.', i: 'Every single non-crypto user cited the same fear: "What if I type the wrong address?"' },
