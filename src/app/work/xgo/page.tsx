  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 52px' }}>
        <Image src="/images/xgo/00-XGo-Wallet-Mobile-App.png" alt="XGo Wallet Mobile App" width={1920} height={900} style={{ width:'100%',height:'auto',display:'block' }} />
      </div>
      ...
      <S num="04 · Branding & Identity">
        ...
        <P>Most crypto wallets have logos and colour schemes. They don't have brands. <B>XGo needed a brand strong enough that users would feel proud to say "I use XGo" the same way they'd say "I use Revolut."</B> In a crowded market, brand is a moat.</P>
      ...
      <S num="06 · Final Design">
        ...
        <Img src="/images/xgo/07-XGo-Marketing-Banners.png" alt="XGo Marketing Banners" cap='Marketing banner set — 15+ formats across multiple sizes. Two campaign themes: "Claim your unique XGo Wallet ID" and "Trade more than 150+ currencies with ease."' />
      </S>

      <S num="07 · Impact & Reflection">
        <H2>What we shipped and<br /><Em>what building from zero taught us</Em></H2>
        <P>XGo Wallet launched on App Store and Google Play and reached 5K+ downloads without paid install campaigns. Growth came from the Wallet.ID virality mechanic: users who claimed alice.xgo.id shared it, which drove organic awareness. <B>The most effective growth feature was a design decision made before a single line of code was written.</B></P>
        <Ins label="The thing I'd do differently">We underinvested in the post-onboarding experience — what users do in the first 72 hours after installing. A price alert system, a portfolio performance notification — something to give users a reason to open the app daily.</Ins>
        <div style={{ display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:12,marginTop:44 }}>
          {[
            ...
            {n:'231',su:'+',d:'Crypto assets supported — with real-time market data, yield indicators and filter/sort in market view'},
            {n:'15',su:'+',d:'Marketing banner formats designed — full acquisition ecosystem from landing page to paid ads'},
            {n:'0→1',su:'',d:'Built entirely from scratch — brand, IA, design system, app, landing page, marketing assets.'},
          ].map(s=>(
      ...
      <NC title="P3 Marine" subtitle="Yacht Management Platform from Scratch" href="/work/p3marine" />
    </>
  )
}
