...
import { H2, Em, P, Img, SecNum } from '@/components/CaseComponents'
  ...
  return (
    <>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/ukrsibbank/01-Manager-workstations-across-Ukraine.png" alt="Manager workstations across Ukraine" cap="Real manager workstations photographed during field visits — the physical evidence of fragmentation: multiple browser tabs, sticky notes, personal phones next to work computers." />
        ...
        <Img src="/images/ukrsibbank/02-Research-findings-presentation.png" alt="Research findings presentation" cap="Research synthesis — Premium Communication Platform discovery results presented to product and compliance stakeholders." />
      </div>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/ukrsibbank/03-Personas-and.png" alt="Personas — Анна and Василь" cap="Detailed personas — Керівник сектору Анна (35) and Менеджер СДКФ Василь (25). Goals, tools, motivation, pain points and wishes documented from real interviews." />
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/ukrsibbank/04-FigJam-CJM-overview.png" alt="FigJam CJM overview" cap="FigJam board — all 4 CJMs and Service Blueprints mapped together to identify cross-scenario patterns." />
        ...
        <Img src="/images/ukrsibbank/07-CJM-Dispute.png" alt="CJM — Dispute" cap="CJM — Unauthorised Charge Dispute. Client emotions tracked across all 7 stages — from Panic at stage 1 to Satisfaction only at the very end. Longest journey to resolution." />
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/ukrsibbank/08-User-flows-overview.png" alt="User flows overview" cap="User flow diagrams — account closure, service refusal, and payment instruction scenarios mapped as end-to-end flows showing system decisions, actor touchpoints, and critical path steps." />
      </div>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/ukrsibbank/11-UkrSibBank-Business-final-design.png" alt="UkrSibBank Business final design" cap="UkrSibBank Business — final design showing the navigation system shared across all UkrSib digital products. The Communication module (Manager Workplace) lives within this same navigation structure." />

        <Img src="/images/ukrsibbank/12-App-switcher.png" alt="App switcher" cap="Unified app switcher — managers navigate between Ukrsib Online, Business, Trading Platform, Communication and Help Center from a single menu. Designed to reduce cognitive load for users who work across multiple products daily." />
      </div>
