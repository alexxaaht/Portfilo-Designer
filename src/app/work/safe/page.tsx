  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 52px' }}>
        <Image src="/images/safe/00-Safe-—-all-screens-overview.png" alt="Safe — all screens overview" width={1920} height={900} style={{ width: '100%', height: 'auto', display: 'block', borderRadius: 14 }} />
      </div>
