  ...
  return (
    <>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/cryptoswift/04-Sale-Detail-—-completed-transaction.png" alt="Sale Detail" cap="Sale Detail — completed transaction view. Sale ID, Payment method, fiat amount (£300,000.00) and crypto amount (16.88 BTC) displayed side by side. Transaction history with blockchain IDs visible but not foregrounded. Send Receipt button accessible from the detail view." />
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, margin: '32px 0' }}>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Ins label="What I'd do differently">We invested heavily in the transaction flow and not enough in the analytics dashboard. Merchants told us post-launch that they wanted deeper insights — not just transaction history, but conversion rates by crypto type, average transaction values, peak sale periods. The analytics we shipped were functional but not insightful. That's the next design sprint.</Ins>
