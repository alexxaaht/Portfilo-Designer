  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 52px' }}>
        <Image src="/images/safe/00-Safe-—-all-screens-overview.png" alt="Safe — all screens overview" width={1920} height={900} style={{ width: '100%', height: 'auto', display: 'block' }} />
      </div>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Ins label="Why this matters at scale">Ukrsib Online has 2M+ users. Even a small improvement in savings engagement directly impacts the bank's liquidity and long-term client retention. This wasn't a nice-to-have feature — it was a strategic bet on transforming how the bank's clients thought about their relationship with money.</Ins>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/safe/01-Research-process-board-—-Service.so-for-.png" alt="Research process board" cap="Full research process board — Kickoff meeting documentation, timeline schedule (19 Jan → 26 Jan), team structure, methods, competitive analysis, hypotheses and references. Built in Figma with the full cross-functional team." />
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/safe/02-Competitive-analysis-—-Privatbank-Monob.png" alt="Competitive analysis" cap="Competitive analysis — Privatbank (envelope feature), Monobank (jar concept), ManiBoks від ПУМБ, plus Korean market references and international players. Strengths and weaknesses mapped per competitor." />
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/safe/03-Hypotheses-from-workshops.png" alt="Hypotheses from workshops" cap='Hypothesis generation workshops — structured "Якщо ми... то ми очікуємо..." format. Grouped by theme: visual progress, notifications, goal flexibility, automatic top-ups, social savings, currency options, naming and localisation.' />
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Img src="/images/safe/05-Safe-—-savings-screens.png" alt="Safe — savings screens" cap='Savings screens — empty state (no products), active state with deposits and savings accounts in UAH/USD/EUR, "Відкрити новий продукт" flow showing Deposit, Savings Account, Securities (OVDP) and Safe options.' />
        <Img src="/images/safe/06-Safe-—-dreams-savings-detail.png" alt="Safe — dreams savings detail" cap='Dreams savings account detail — hero image personalisation, progress tracking, "Перейти в Dreams" shortcut, account actions (Реквізити, Деталі, Виписка, Перейменувати). Two variants of the actions drawer tested in A/B.' />
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, margin: '32px 0' }}>
          <div style={{ background: bg2, border: `1px solid ${line}`, borderRadius: 14, padding: 28 }}>
      ...
      <div style={{ padding: '80px 52px', maxWidth: 1160, margin: '0 auto', borderBottom: `1px solid ${line}` }}>
        ...
        <Ins label="What I'd change">We invested heavily in the goal-creation experience and almost nothing in the "goal achieved" moment. When a user reaches their savings target, the app shows a standard success state. That moment deserved a celebration — something that reinforced the behaviour and motivated a new goal. It's the most underdesigned part of the product and the first thing I'd fix in the next iteration.</Ins>
