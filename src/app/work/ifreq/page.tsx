  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 52px' }}>
        <Image src="/images/ifreq/01-IFREQ-—-Turn-Data-Into-Progress.png" alt="IFREQ" width={1920} height={900} style={{ width:'100%', height:'auto', display:'block' }} />
      </div>
      ...
      <S num="06 · Booking & Payment — Test Flow · Test Booking · Packages">
        <H2>Test Flow · Test Booking ·<br /><Em>Designed to remove fear</Em></H2>
      ...
      {/* 07 SCOUT CRM */}
      <S num="07 · Scout CRM — Designing for Experts">
        <H2>Scouts think in comparisons.<br /><Em>The dashboard had to too.</Em></H2>
        <P>The scout dashboard was the most technically complex product in the ecosystem. <B>Scouts are professional evaluators.</B> They don't need the interface to explain football. They need it to get out of their way and let them compare players efficiently.</P>
      ...
      {/* 08 DESIGN SYSTEM */}
      <S num="08 · Design System">
        <H2>The foundation that made<br /><Em>three products feel like one</Em></H2>
        <P>The IFREQ design system was the infrastructure that allowed a team of multiple designers and developers to work in parallel without visual inconsistency. <B>The most important decision wasn't aesthetic — it was the colour token structure.</B></P>
        <div style={{ background:bg2, border:`1px solid ${line}`, borderRadius:14, overflow:'hidden', margin:'32px 0' }}>
          <Image src="/images/ifreq/11-IFREQ-Inputs---Buttons.png" alt="Inputs & Buttons" width={1160} height={600} style={{ width:'100%', height:'auto', display:'block' }} />
        </div>
        <div style={{ fontSize:12, fontWeight:300, color:dim, marginBottom:32, lineHeight:1.6 }}>Inputs & Buttons — all states: default, hover, active, disabled, error. Search fields, tag filters, sort controls, and primary/secondary button variants in lime and dark themes.</div>
