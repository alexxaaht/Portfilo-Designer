  ...
  return (
    <>
      ...
      <section className="min-h-screen px-8 md:px-14 pt-[120px] pb-16 relative flex flex-col justify-center overflow-hidden">
        ...
        <a
          href="#work"
          className="absolute bottom-20 left-1/2 -translate-x-1/2 w-14 h-14 rounded-full border border-white/20 bg-white/10 flex items-center justify-center text-white/60 no-underline transition-all duration-300 hover:border-white/40 hover:text-white/90 hover:-translate-x-1/2 hover:translate-y-1 z-10"
        >
